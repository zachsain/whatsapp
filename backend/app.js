...
// const ngrok = require('@ngrok/ngrok'); // Import ngrok
// const app = express();
// const PORT = process.env.PORT || 1337;

// Use ngrok to connect to your local server
// (async function () {
//   const url = await ngrok.connect({
//     addr: PORT,
//     authtoken_from_env: true,
//     verify_webhook_provider: "whatsapp",
//     // Add other ngrok configuration options if needed
//   });

//   console.log(`Webhook server is publicly accessible at: ${url}`);
// })();
